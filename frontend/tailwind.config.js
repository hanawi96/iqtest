...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // TestIQ Brand Colors - Tone sáng, hiện đại, tinh tế
        primary: {
          50: '#f0f9ff',
          100: '#e0f2fe',
          200: '#bae6fd',
        ...
        // Difficulty Colors (Mountain levels)
        difficulty: {
          1: '#10B981', // Easy - Green
      ...
      animation: {
        ...
        'pulse-success': 'pulseSuccess 1s ease-in-out infinite',
      ...
      boxShadow: {
        ...
        'strong': '0 10px 50px -15px rgba(0, 0, 0, 0.25)',
      },
    },
  },
  plugins: [
